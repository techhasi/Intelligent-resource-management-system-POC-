...
# Read the CSV files and convert timestamps
ec2_df = pd.read_csv('reduced_ec2_data.csv')
rds_df = pd.read_csv('reduced_rds_data.csv')
ecs_df = pd.read_csv('reduced_ecs_data.csv')
...
# Save the merged dataset
df.to_csv('reduced_merged_cloud_metrics.csv', index=False)

print("\nMerged dataset saved as 'reduced_merged_cloud_metrics.csv'")
print("\nColumns in the dataset:")
print(df.columns.tolist())
print("\nSample of merged data:")
print(df.head())